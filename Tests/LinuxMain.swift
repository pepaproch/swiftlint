...
extension CSOB_OWASPTests {
    static var allTests: [(String, (CSOB_OWASPTests) -> () throws -> Void)] = [
        ("testStructure", testStructure),
        ("testSyntaxMap", testSyntaxMap),
...
extension RulesTests {
    static var allTests: [(String, (RulesTests) -> () throws -> Void)] = [
        ...
        ("testPathTraversal", testPathTraversal)
    ]
}
...
XCTMain([
    ...
    testCase(CSOB_OWASPTests.allTests),
